...
document.addEventListener("DOMContentLoaded", () => {
  // Solo desktop (md = 768px en Tailwind)
  ...
  cards.forEach(card => {
    card.addEventListener("mouseenter", () => {
      stopAutoRoll();
      if (card.classList.contains("hero-pos-left")) rotateOnceLeftToCenter();
      else if (card.classList.contains("hero-pos-right")) rotateOnceRightToCenter();
    });
